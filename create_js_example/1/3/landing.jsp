...
.bg .content .cont2 span.t3 {font-size:2.0em;margin-top:-10%;}/*margin-top퍼센트로 전화번호 위치 조정가능*/
	...
	<div class="body">
		<div class="basic header">
			<div class="bg">
				...
				<div class="content">
					<div class="cont1">
						<div class="circle"><img id="image" src="" style="position:relative; border-radius:50%;border: solid 5px #1378a0;"></div><!--추가한 div -->
					</div>
					<div class="cont2">
						<div class="inner">
