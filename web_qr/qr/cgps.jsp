...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#myModal').on('show.bs.modal', function() {
			$("#myModal .modal-body").prepend("<input id='pac-input' class='controls' type='text' placeholder='주소 검색'>");
		});
		...
		$('.btnChoice').on('click', function() {
			$("#myModal").modal("hide");
			$("#lat").val($("#latHidden").val());
			$("#lng").val($("#lngHidden").val());
...
<body>
	...
	<div class="input-group input-group pull-right margin-t-10">
		...
		<input type="text" id="addr" class="form-control" style="width: 80%;" value=""   readonly="readonly">
		<!-- 모달창을 띄울 버튼 -->
		<button type="button" class="btn btn-primary btnMap" style="width: 20%;">주소검색</button>
	...
	<div class="input-group input-group pull-right margin-t-10">
		...
		<input type="text" id="lat"  class="form-control" style="width: 100%;" value=""  readonly="readonly">
	</div>
	<div class="input-group input-group pull-right margin-t-10">
		<input id="lngHidden" type="hidden" value="">
		<span class="input-group-addon" id="basic-addon" style="width: 5%;">경도</span>
		<input type="text" id="lng"  class="form-control" style="width: 100%;" value="" readonly="readonly">
	</div>
	<div class="input-group input-group pull-right margin-t-10"
		style="width: 100%; text-align: center;">
		<button type="button" class="btn btn-primary btn-m" onclick="create(3)"
