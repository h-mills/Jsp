...
<body>
	...
	<table>
		...
		<c:forEach items="${excelCityData }" var="excelCityData">
		<tr>
			<td>${excelCityData.nation}</td>
			<td>${excelCityData.city}</td>
			<td>${excelCityData.address}</td>
			<td>${excelCityData.date}</td>
		</tr>
		</c:forEach>
	</table>
</body>
