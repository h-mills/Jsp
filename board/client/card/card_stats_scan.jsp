		...
		<div>
			<div>
				<div class="pull-left">
					<p class="pull-left text-muted stats-date" style="width: 100%; margin-top: 20px;">
						...
						<span class="label label-primary">총스캔 횟수</span>&nbsp;&nbsp;${count }&nbsp;&nbsp;
			...
			<div class="pull-left inbox">
				<c:choose>
					...
					<c:otherwise>
						<h4><img src="/img/png/glyphicons-42-charts.png" width="18px" alt="" style="margin-bottom: 6px; margin-right: 8px;">월별 현황</h4>
						<div class="pull-left inbox" id="mGraph"></div>
						<h4><img src="/img/png/glyphicons-42-charts.png" width="18px" alt="" style="margin-bottom: 6px; margin-right: 8px;">일별 현황</h4>
						<c:forEach items="${monthData }" varStatus="i">
							<div class="pull-left inbox" id="dGraph${i.index }"></div>
						</c:forEach>
						<h4><img src="/img/png/glyphicons-42-charts.png" width="18px" alt="" style="margin-bottom: 6px; margin-right: 8px;">시간대별 현황</h4>
