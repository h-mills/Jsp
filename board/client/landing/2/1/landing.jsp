...
<title>HiddenTagBiz for Kakao</title>
<style>
...
.nav_right ul li.active {background-color:#1378a0;}
.nav_right ul li.active a {color:#fff; font-weight:bold;}
.nav_right ul li:hover{background-color:#1378a0;}
...
.bg {position:relative;background-image:url('/img/landing/2/1/background.jpg'); width:100%; height:650px; background-repeat: no-repeat; background-size: cover;}
.circle img {position:relative; border-radius:50%;border: solid 5px #1378a0; width:225px; height:225px; margin-left:5%;}
...
button{width:100%; margin:0; padding:2.5% 0; font-size:2.0em; color:#fff; background:#1378a0; box-shadow:0 3px 0 rgba(0,120,170,1.0); text-align:center;}
...
<body>
	...
	<div class="body">
		<div class="basic header">
			<div class="bg">
				<img src="" style="position:relative;width:100%;">
				<div class="content">
					<div class="cont1">
						<div class="circle"><img id="image" src="/img/apeach.jpg"></div>
					</div>
					<div class="cont2">
						<div class="inner">
		...
		<div style="margin-top: 40px;">
			<div id="siteDiv" class="basic btn">
				<center>
					<a href="http://www.thecosmedium.com/"><button>http://www.thecosmedium.com/</button></a>
				</center>
			</div>
