...
.bg {position:relative;background-image:url('/img/landing/6/1/backgroundimg.png'); width:100%; height:650px; background-repeat: no-repeat; background-size: cover;}
...
.bg .content .cont1 .circle img {position:absolute;width:220px; height:220px; border-radius:50%;border: 5px #1378a0; top:10px; left:10px;}
...
.bg .content .cont2 span.t3 {font-size:2.0em;margin-top:-10%;}
...
<body>
	<div class="basic topnav" style="background-color: #f8f8f8;">
		<div class="nav_left">
			<a href="http://hiddentag.co.kr/"><img src="/img/landing/6/1/logo.png"/></a>
		</div>
	...
	<div class="body">
		<div class="basic header">
			<div class="bg">
				<img src="" style="position:relative; margin-top:5%; margin-left:58%; width:40%;"/>
				<div class="content">
					<div class="cont1">
				<div class="circle"><img id="" src="/img/landing/6/1/sejongmall_01.png" style="position:relative; border-radius:50%;border: solid 5px #1378a0;"></div>
					</div>
					<div class="cont2">
						<div class="inner">
		...
		<div style="margin-top: 40px;">
			<div id="siteDiv" class="basic btn">
				<center>
					<a href="http://www.sejongmall.co.kr"><button>http://www.sejongmall.co.kr</button></a>
				</center>
			</div>
