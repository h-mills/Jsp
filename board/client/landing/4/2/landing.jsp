...
.nav_right ul li.active {background-color:#381e1f;}
.nav_right ul li.active a {color:#fff; font-weight:bold;}
.nav_right ul li:hover{background-color:#381e1f;}
...
.bg {position:relative;background-image:url('/img/landing/4/1/img/kakao.jpg'); width:100%; height:650px; background-repeat: no-repeat; background-size: contain;}
...
button{width:100%; margin:0; padding:2.5% 0; font-size:2.0em; color:#fff; background:#381e1f; box-shadow:0 3px 0 rgba(0,120,170,1.0); text-align:center;}
	...
	<div class="body">
		...
		<div style="margin-top: 40px;">
			<div id="siteDiv" class="basic btn">
				<center>
					<a href="http://www.kakaocorp.com/main"><button>http://www.kakaocorp.com/main</button></a>
				</center>
			</div>
