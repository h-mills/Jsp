...
<body class="map-layout small">
	...
	<div>
	<div id="wmap_main" style="height: 60vw; width: 100%;">
		<div class="pull-left inbox" id="map_loading" style="width: 100%; right:8%; text-align: center;">
			<img alt="loading" src="/images/map/maploading.gif" style="width: 50%; height: 100%;">
		</div>
		<div class="pull-left inbox" id="wmap" style="width: 100%; height: 100%; "></div>
	</div>
	<script>
		var center_lat = 0.0;
		var center_lng = 0.0;
		...
		var wmap, zoomset = 0;
		if(document.getElementById("wmap").offsetWidth > 1024)
		{
			zoomset = 3;
		}
		else if(document.getElementById("wmap").offsetWidth > 512)
		{
			zoomset = 2;
		}
		else
					...
					for(var i=0; i<JSONobj.list.length; i++){
						...
						if (JSONobj.list[i].count < 1000)
						{
							marker = L.marker(L.latLng(JSONobj.list[i].lat, JSONobj.list[i].lng),{
								...
								$("#map-area").html('<div class="map-div" id="map" style="padding: 20px 0px 20px 0px; height: 51%; margin-top: 76.5%;"></div>');
							    ...
							    setTimeout(function() {
							    	 tiles = L.tileLayer(
							    		...
							    		markerList.length = 0;
							 			...
							 			$(".map-div").append("<img id='loading' src='/appservice/img/ajax-loader.gif' style='width: 5%; position: fixed; z-index: 1000; left: 49%; top: 65%;'>");
...
/* 						marker.bindPopup(title); */
						wmap.addLayer(marker);
					}
					$('#map_loading').css("display", "none");
					$('#wmap').css("display", "block");
				}
		...
		populate(L.latLng(center_lat, center_lng));
		
		wmap.on('resize', function(e)
		{
			if(document.getElementById("wmap").offsetWidth > 1024)
			{
				wmap.setMaxZoom(3);
   ...
   <div id="tap_panel" style="bottom: 55%;">
          <ul class="tab">
	...
	<div id="map-area">
	<div class="map-div" id="map" style="padding: 20px 0px 20px 0px; height: 51%; margin-top: 76.5%;">
	</div>
	</div>
